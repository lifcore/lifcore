...
export default function PipelinePage() {
  ...
  useEffect(() => {
    carregar()
    obterMetricasWorkspace('lifcare', { corretorId: corretorVisualizado }).then(setMetricas)
  ...
  return (
    <div className="pipeline-page" data-theme="lcds">
      {metricas && (
        <>
          <WorkspaceHeader workspace={WORKSPACES.lifcare} metricas={metricas} />
          <WorkspaceKpiBar workspace={WORKSPACES.lifcare} metricas={metricas} />
