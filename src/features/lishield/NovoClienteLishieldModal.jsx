...
export default function NovoClienteLishieldModal({ onFechar, onCriado, corretorAlvoId }) {
...
function Formulario({ tipoPessoa, onFechar, onCriado, onVoltar, corretorAlvoId }) {
  ...
  return (
    <>
      ...
      <label>Data de vigência/renovação (se já tiver um seguro)</label>
