...
export default function ClienteDetailLishieldPage() {
  ...
  const posicoes = normalizarPosicoes(apolices, 'apolices', 'lishield')
  ...
  return (
    <div className="cliente-detail-page" data-theme="lcds">
      ...
      <div className="cliente-aba-conteudo">
        ...
        {abaAtiva === 'Cotações' && (
          <CotacoesLishieldTab clienteId={cliente.id} cotacoes={cotacoes} onAtualizado={carregar} perfil={perfil} />
        )}
