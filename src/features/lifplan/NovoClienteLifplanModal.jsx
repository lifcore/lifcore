...
export default function NovoClienteLifplanModal({ onFechar, onCriado, corretorAlvoId }) {
...
function Formulario({ tipoPessoa, onFechar, onCriado, onVoltar, corretorAlvoId }) {
  ...
  return (
    <>
      ...
      <label>Data relevante (vencimento, aniversário de contrato, se souber)</label>
