 ...
 */
export default function CotacaoLifsureForm({ clienteProspectId, cotacaoExistente, casoId, onSalvo, onCancelar }) {
    ...
    <div className="cotacao-form">
      ...
      {cadastrandoNova && (
        <div className="ls-card" style={{ padding: '0.6rem', marginBottom: '0.6rem' }}>
          ...
          <input value={nomeNovaSeguradora} onChange={(e) => setNomeNovaSeguradora(e.target.value)} placeholder="Ex: Porto Seguro, Tokio Marine..." />
