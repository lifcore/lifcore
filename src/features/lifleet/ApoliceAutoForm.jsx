...
export default function ApoliceAutoForm({ clienteProspectId, tipoPessoa, apoliceExistente, operadoraIdInicial, operadoraNomeInicial, onSalvo, onCancelar }) {
  ...
  //
  // CORREÇÃO (achado do Raphael, 15/08): quando este form é aberto a
  // partir de "Formalizar Apólice" de uma cotação já fechada com
  // seguradora escolhida, `operadoraIdInicial`/`operadoraNomeInicial`
  // pré-preenchem o campo — o corretor não precisa selecionar de novo
  // algo que já tinha escolhido na cotação (e, mais importante, não
  // corre risco de salvar a apólice sem seguradora por esquecimento).
  // Continua editável — o corretor pode trocar se a seguradora final
  // divergir da cotação.
