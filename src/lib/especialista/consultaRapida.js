...
/**
 * Consulta Rápida — mesmo motor de raciocínio único da Demanda, só que
 * sem ciclo de vida (sem status, sem próxima ação, sem obrigação de
 * fechar). Pode ser vinculada a um cliente depois, virando Demanda.
 */
export async function atenderConsultaRapida({ demandaTexto, usuarioId, organizacaoId, imagens = [], consultaIdExistente = null }) {
...
/**
 * Converte uma Consulta Rápida em Demanda de verdade, vinculando a um
 * cliente — usado quando o corretor percebe, no meio da conversa, que
