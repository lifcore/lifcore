...
{"discrepancias": [{"descricao": string}], "conclusao": "consistente"|"discrepancias_encontradas"}`
  return chamarGemini(prompt, `TEXTO ORIGINAL DO BLOCO:\n\n${textoOriginal}\n\n---\n\nRESUMO DO QUE FOI GRAVADO NO BANCO PARA ESSE BLOCO:\n\n${resumoGravado}`, 'Validação Cruzada')
}

export default { nome: 'gemini', interpretarPlanos, interpretarPrecos, interpretarRegraMercado, interpretarRede, validarConsistencia }
